...
(0, ava_1.default)('Should be "lorem.words(1)"', function (t) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var res;
    return tslib_1.__generator(this, function (_a) {
        res = gen.custom({ generator: fakerJS, input: 'lorem.words(1)' });
        t.true(typeof res === 'string');
        return [2 /*return*/];
    });
}); });
(0, ava_1.default)('Should be "datatype.number({"max": 1})"', function (t) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var res;
    return tslib_1.__generator(this, function (_a) {
        res = gen.custom({
            generator: fakerJS,
...
(0, ava_1.default)('Should be "datatype.number({"min": 1, "max": 2})"', function (t) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var res;
    return tslib_1.__generator(this, function (_a) {
        res = gen.custom({
            generator: fakerJS,
...
(0, ava_1.default)('Should be "lorem.words()[0]"', function (t) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var res;
    return tslib_1.__generator(this, function (_a) {
        res = gen.custom({ generator: fakerJS, input: 'lorem.words()[0]' });
        t.true(typeof res === 'string');
        return [2 /*return*/];
    });
}); });
(0, ava_1.default)('Should be "lorem.words(1)[0]""', function (t) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var res;
    return tslib_1.__generator(this, function (_a) {
        res = gen.custom({ generator: fakerJS, input: 'lorem.words(1)[0]' });
        t.true(typeof res === 'string');
        return [2 /*return*/];
    });
}); });
...
//# sourceMappingURL=Generator.generator.spec.js.map